...
class MT22Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MT22Parser#arith_ops.
    def visitArith_ops(self, ctx:MT22Parser.Arith_opsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MT22Parser#bool_ops.
    def visitBool_ops(self, ctx:MT22Parser.Bool_opsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MT22Parser#str_ops.
    def visitStr_ops(self, ctx:MT22Parser.Str_opsContext):
        return self.visitChildren(ctx)
